...
class EventScanner:
    ...
    def scan(self, start_block, end_block, start_chunk_size=20, progress_callback=Optional[Callable]) -> Tuple[
        ...
        while current_block <= end_block:
            ...
            logger.debug(
                "Scanning 'PoolCreated' for blocks: %d - %d, chunk size %d, last chunk scan took %f, last logs found %d",
...
if __name__ == "__main__":
    ...
    def run():
        ...
        infura_url = 'https://mainnet.infura.io/v3/' + str(prjectId)
        ...
        ERC20 = web3.eth.contract(abi=factoryAbi)
        ...
        scanner = EventScanner(
            ...
            contract=ERC20,
            state=state,
            events=[ERC20.events.PoolCreated],
            filters={"address": factoryAddress},
